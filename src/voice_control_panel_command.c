...
char* g_command_1st[NUM_COMMAND_1ST] = {
	"IDS_HOMESCREEN", "IDS_INTERNET", "IDS_TASK_MANAGER", "IDS_NOTIFICATION", "IDS_HELP", "IDS_CLOSE"
};
char *g_hint_1st[NUM_COMMAND_1ST] = {
	"IDS_HINT_HOMESCREEN", "IDS_HINT_INTERNET", "IDS_HINT_TASK_MANAGER", "IDS_HINT_NOTIFICATION", "IDS_HINT_HELP", "IDS_HINT_CLOSE"
};
